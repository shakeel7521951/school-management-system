...
const DepartTeacherComplaintModal = ({
  ...
  useEffect(() => {
    if (editModal) {
      setFormData({
        employeeName: editModal.employeeName || dummyData.employeeName,
        jobTitle: editModal.jobTitle || dummyData.jobTitle,
        department: editModal.department || dummyData.department,
        date: editModal.date
...
export default DepartTeacherComplaintModal;
