                ...
                <div className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-2 sm:gap-3 mb-8 sm:mb-12 mt-6 sm:mt-10">
                    {teamCategories.map((category) => (
                        <button
                            ...
                            className={`px-1 sm:px-6 py-2 sm:py-3 md:rounded-full rounded-xl md:font-medium text-[12px] md:text-xl transition-all duration-300 transform hover:scale-105 ${activeCategory === category.id
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
                    {filteredTeam.map((member) => (
                        ...
                        >
                            ...
                            <div
                                className={`h-2 bg-gradient-to-r ${departmentColors[member.department] ||
