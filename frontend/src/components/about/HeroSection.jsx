...
const HeroSection = () => {
  return (
    <section className='relative pt-9 min-h-[70vh] md:h-[90vh] flex items-center justify-center text-white overflow-hidden'>
      ...
      {/* Content */}
      <motion.div
        className='relative z-10 max-w-[90%] md:max-w-5xl px-6 flex flex-col items-center text-center py-12'
      ...
      >
        ...
        <p className='text-lg md:text-xl lg:text-2xl mb-8 opacity-95 leading-relaxed text-white max-w-3xl'>
          ...
          <span className='font-semibold'>values</span>, and{' '}
          <span className='font-semibold'>skills</span> to excel in life and
