...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-center p-1">
      <nav className="relative overflow-hidden border border-blue-500/20 p-1 w-full max-w-7xl rounded-xl">
        {/* Animated Background */}
        ...
        <div className="relative px-4 sm:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 group">
              ...
              <span className="text-xl sm:text-3xl font-bold text-white">BRS</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-10">
              {['Home', 'About', 'Complaints', 'Features', 'Contact'].map((item) => (
                ...
                >
                  <span className="text-blue-100 transition-all duration-300 group-hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500 bg-[length:200%_auto] group-hover:animate-gradient-x">
                    {item}
                  </span>
                  <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-500 via-cyan-400 to-blue-500 group-hover:w-full transition-all duration-500 rounded-full" />
            ...
            <div className="flex items-center space-x-4">
              ...
              <button className="hidden sm:flex relative group">
                ...
                <div className="relative px-5 sm:px-7 py-2 sm:py-3 bg-blue-950 rounded-lg leading-none flex items-center space-x-2">
                  <span className="text-blue-200 group-hover:text-white transition duration-200">
                    Login
                  </span>
                  <HiArrowRight className="w-5 h-5 text-blue-200 group-hover:text-white transform group-hover:translate-x-1 transition-all duration-200" />
                </div>
              </button>
              ...
              >
                ...
                <div className="relative p-2 bg-blue-950 rounded leading-none">
                  {isMenuOpen ? (
                    <HiX className="w-6 h-6 text-blue-200 group-hover:text-white" />
                  ) : (
                    <HiMenu className="w-6 h-6 text-blue-200 group-hover:text-white" />
                  )}
                </div>
              </button>
            </div>
