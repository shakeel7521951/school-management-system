...
const HeroComplaints = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/50 via-navy/40 to-black/50"></div>
        ...
        >
         <Link to="/complainform">
          <button
            ...
            className="px-8 py-4 rounded-xl bg-white text-blue-800 font-semibold shadow-lg hover:shadow-2xl hover:scale-105 hover:opacity-90 transition-all duration-300 flex items-center justify-center"
          >
            <svg
