        ...
        <div className="py-16 px-4 sm:px-6 md:px-12 bg-gradient-to-r from-blue-50 via-white to-pink-50">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl hover:scale-105 transition-transform duration-300" data-aos="fade-up">
                ...
                <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.90220123325!2d-46.6485!3d-23.5465!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c9b0e129bf%3A0x9b8c53ed77d05f0a!2sSchool!5e0!3m2!1sen!2s!4v1600000000000!5m2!1sen!2s"
                    width="100%"
                    height="400"
                ...
                <div className="absolute bottom-6 right-6 bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl shadow-md z-20">
                    <p className="text-sm md:text-base text-gray-700">
                        Click and drag the map to explore our school location.
                    </p>
                </div>
            </div>
        </div>
