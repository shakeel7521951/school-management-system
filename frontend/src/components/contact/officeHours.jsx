            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 md:py-32 py-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                ...
                <div className="flex flex-col gap-6 text-white lg:w-1/2" data-aos="fade-right">
                    ...
                    <p className="text-lg lg:text-xl text-center text-gray-200">
                        We are here to assist you! Check our office hours below and reach out for urgent inquiries.
                    </p>
                </div>
                ...
                <div className="lg:w-1/2 flex flex-col gap-6" data-aos="fade-left">
                    {hours.map((hour, index) => (
                        ...
                        >
                            <span className="text-white text-sm lg:text-xl font-medium">{hour.day}</span>
                            <span className={`${hour.time.toLowerCase() === "closed" ? "text-red-500 font-bold" : "text-[#d08700] font-semibold"} text-sm lg:text-xl`}> 
                                {hour.time}
                            </span>
                        </div>
                    ))}
