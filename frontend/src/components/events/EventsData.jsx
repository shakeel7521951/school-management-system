  ...
  const events = [
    {
      ...
      description:
        'A full day of inter-house sports competitions and activities.',
      fullDescription:
      ...
      importantNotes:
        'Students must wear proper sports gear and bring water bottles.'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      location: 'Auditorium',
      description:
        'Evening of performances by the school band, choir, and orchestra.',
      fullDescription:
    ...
    },
    {
      ...
      location: 'Main Hall',
      description:
        'Regional competition testing math skills and logical reasoning.',
      fullDescription:
        'The Math Olympiad brings together bright students to compete in speed calculations, puzzles, and problem-solving rounds. Guests are welcome to attend the final round and awards ceremony. This event promotes excellence and a passion for mathematics.',
      category: 'academic',
      image: './events/5.avif',
    ...
    <div className='min-h-screen bg-gradient-to-b from-indigo-50 to-purple-100 py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-12' data-aos='fade-down'>
          <h1 className='text-4xl font-bold text-[#104c80] mb-4'>
            School Events & Activities
          </h1>
          <p className='text-xl text-[#104c80] max-w-3xl mx-auto'>
            Stay updated with all the upcoming events, activities, and important
            dates at our school community
          </p>
        </div>
        ...
        >
          <div className='flex items-center bg-white rounded-lg shadow-sm border border-indigo-200 px-4 py-3 w-full md:w-96'>
            ...
            <input
              ...
              className='outline-none w-full bg-transparent text-[#104c80] placeholder-indigo-400'
              value={searchQuery}
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                  activeFilter === category.id
                    ? 'bg-gradient-to-r from-[#104c80] to-[#4d7db3] text-white shadow-lg'
                    : 'bg-white text-[#104c80] border border-[#4d7db3] hover:bg-[#f0f6fb] hover:shadow-md'
                }`}
              >
                {category.name}
              </button>
        ...
        {filteredEvents.length > 0 ? (
            ...
            {filteredEvents.map((event, index) => (
              ...
              >
                <div className='h-48 overflow-hidden relative'>
                  ...
                  />
                  {/* Category Badge */}
                  <div className='absolute top-4 right-4 bg-gradient-to-r from-[#104c80] to-[#4d7db3] text-white text-xs font-bold px-3 py-1 rounded-full'>
                    {event.category.toUpperCase()}
                  </div>
                </div>
                <div className='p-6'>
                  <h3 className='text-xl font-semibold text-[#104c80] mb-2'>
                    {event.title}
                  </h3>
                  <p className='text-[#2c5e99] mb-4'>{event.description}</p>

                  <div className='space-y-3 mb-5'>
                    <div className='flex items-center text-[#104c80]'>
                      <FaCalendarAlt className='mr-3 text-[#4d7db3]' />
                      <span>{formatDate(event.date)}</span>
                    </div>
                    <div className='flex items-center text-[#104c80]'>
                      <FaClock className='mr-3 text-[#4d7db3]' />
                      <span>{event.time}</span>
                    </div>
                    <div className='flex items-center text-[#104c80]'>
                      <FaMapMarkerAlt className='mr-3 text-[#4d7db3]' />
                  ...
                  <button
                    ...
                    className='w-full bg-gradient-to-r from-[#104c80] to-[#4d7db3] hover:from-[#0d3a66] hover:to-[#5b8fbe] text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 transform hover:-translate-y-0.5 shadow-md hover:shadow-lg'
                  >
                    View Details
                  </button>
                </div>
          ...
          <div
            ...
            data-aos='zoom-in'
          >
            <FaRegCalendarCheck className='mx-auto text-5xl text-[#4d7db3] mb-4' />
            <h3 className='text-2xl font-medium text-[#104c80] mb-2'>
              No events found
            </h3>
            <p className='text-[#2c5e99]'>
          ...
          <div className='flex flex-col md:flex-row items-center justify-between'>
            <div className='mb-6 md:mb-0 md:mr-6'>
              ...
              <p className='text-blue-100'>
                Never miss an event! Subscribe to our events calendar.
              </p>
            </div>
            <div className='flex flex-col sm:flex-row gap-3 w-full md:w-auto'>
              <input
                ...
                className='px-8 py-3 rounded-lg border border-[#3b82f6] focus:outline-none focus:ring-2 focus:ring-[#104c80] text-[#104c80] flex-grow placeholder-blue-200'
              />
              <button className='bg-white text-[#104c80] hover:bg-blue-50 font-bold px-6 py-3 rounded-lg transition-colors shadow-md'>
                Subscribe
              </button>
            </div>
          </div>
