          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-black/50 flex items-center justify-center">
              <div className="text-center text-white max-w-5xl px-6">
                ...
                <button className="px-12 py-4 text-xl bg-gradient-to-r from-[#2E2C7E] to-[#2E2C7E] rounded-lg text-white font-semibold shadow-lg hover:scale-105 transition mt-4">
                   MORE
                </button>
              </div>
            </div>
