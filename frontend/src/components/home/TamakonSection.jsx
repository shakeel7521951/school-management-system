    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-[#273C66] to-[#1A4480] text-white p-6 sm:p-8 md:p-10 rounded-2xl flex flex-col justify-center items-center text-center mb-12 sm:mb-16">
          ...
          <Link
            to="/login"
            className="w-28 sm:w-32 md:w-[150px] px-5 sm:px-6 py-2 sm:py-3 bg-white text-[#1A4480] text-center font-semibold rounded-full shadow hover:bg-gray-100 transition"
          >
