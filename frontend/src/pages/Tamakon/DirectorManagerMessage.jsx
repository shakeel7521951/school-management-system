      ...
      <div className="container mx-auto px-6 lg:px-20 py-20">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl w-[600px] md:text-4xl font-bold text-[#104c80] mb-8 leading-snug">
              Welcome to Tamakon School specializing in learning disabilities
            </h2>
            <div className="space-y-6 text-gray-700 leading-relaxed text-justify text-[1.05rem]">
              <p>
            ...
            {/* Signature */}
            <div className="mt-10">
              <p className="text-lg font-semibold text-[#104c80]">
                Director Manager
              </p>
              <p className="text-2xl font-bold text-gray-900">
                Mona Almolla
              </p>
              <div className="w-20 h-1 bg-[#104c80] mt-2 rounded-full"></div>
            </div>
          </motion.div>
          ...
          >
            <img
              ...
              className="rounded-3xl shadow-2xl w-full max-w-lg md:max-w-xl object-cover ring-4 ring-[#104c80]/20"
